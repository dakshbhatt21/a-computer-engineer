        ...
        if (data != null && data.getData() != null && resultCode == RESULT_OK) {
            ...
            if (isKitKat && DocumentsContract.isDocumentUri(PickImageActivity.this, uri)) {
                ...
                if ("com.android.externalstorage.documents".equals(uri.getAuthority())) {
                    ...
                    try {
                        cursor = PickImageActivity.this.getContentResolver().query(contentUri, projection, null, null,
                                null);
                    ...
                    try {
                        cursor = PickImageActivity.this.getContentResolver().query(contentUri, projection, selection, selectionArgs,
                                null);
                        if (cursor != null && cursor.moveToFirst()) {
                ...
                try {
                    cursor = PickImageActivity.this.getContentResolver().query(uri, projection, null, null,
                            null);
                    if (cursor != null && cursor.moveToFirst()) {
                        int column_index = cursor.getColumnIndexOrThrow(column);
                        strImagePath = cursor.getString(column_index);
